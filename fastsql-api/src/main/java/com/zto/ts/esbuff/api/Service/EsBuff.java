...
@Service
public class EsBuff implements ApplicationListener<DynamicConfigChangeSpringEvent>
{
    ...
    public void addSql(Class<?> type, String dbSource, String sql, Map<String, AnchorType> mapAnchor)
    {
        if (type == null
        ...
        virtualSqlApi.addSql(virtualSqlDto);
    }
